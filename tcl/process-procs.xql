...
<queryset>
  ...
  <fullquery name="pm::process::remove_assignees.delete_assignments">
    <querytext>
      DELETE FROM
      pm_process_task_assignment
      WHERE
  ...
  <fullquery name="pm::process::remove_assignees.delete_assignment">
    <querytext>
      DELETE FROM
      pm_process_task_assignment
      WHERE
  ...
  <fullquery name="pm::process::assign.add_assignment">
    <querytext>
        INSERT INTO
        pm_process_task_assignment
        (process_task_id,
  ...
  <fullquery name="pm::process::remove_dependency.delete_dependencies">
    <querytext>
  ...
  <fullquery name="pm::process::remove_dependency.delete_dependency">
    <querytext>
      DELETE FROM pm_process_task_dependency
  ...
  <fullquery name="pm::process::add_dependency.add_dependency">
    <querytext>
