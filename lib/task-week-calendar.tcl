...
if {[empty_string_p $t_date]} {
    ...
    set t_date [lc_time_fmt $user_now_time "%x"]
}

set user_id [ad_conn user_id]
set base_url [apm_package_url_from_id $package_id]
set start_date $t_date

# Convert date from user timezone to system timezone
#set system_start_date [lc_time_conn_to_system "$t_date 00:00:00"]
...
set previous_week_url "?view=week&t_date=[ad_urlencode [dt_julian_to_ansi [expr $first_weekday_julian - 7]]]&display_p=$display_p\#top"
set next_week_url "?view=week&t_date=[ad_urlencode [dt_julian_to_ansi [expr $first_weekday_julian + 7]]]&display_p=$display_p\#top"
