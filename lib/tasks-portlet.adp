...
<tr>
  <td colspan="2" class="fill-list-middle">
    <include src=/packages/project-manager/lib/tasks project_id="@project_id@" project_item_id="@project_item_id@" return_url="@return_url@" elements="@elements@" display_mode="list" fmt=@fmt@ instance_id="@instance_id@" status_id="1">
  </td>
</tr>
