...
# general comments
# ----------------
set comments [general_comments_get_comments -print_content_p 1 -print_attachments_p 1 -print_user_info_p 0 $project_item_id "[ad_conn url]?project_item_id=$project_item_id"]
