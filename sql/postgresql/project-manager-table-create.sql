...
CREATE INDEX pm_task_logger_proj_map_logger_entry_inx ON pm_task_logger_proj_map(logger_entry);
...
CREATE INDEX pm_projects_logger_project_inx ON pm_projects(logger_project);
